...
Retrieved from CapyMOA at Apr 08, 2025,
https://github.com/adaptive-machine-learning/CapyMOA/blob/main/src/capymoa/ssl/classifier/_osnn.py
"""
...
class OSNeuralNetwork(nn.Module):
    ...
    def update_sigma(self):
        # The width of basis function is set to a proportion β
        # of the mean of the Euclidean distances to the other centers.
    ...
    def center_adjustment(self):
        # The samples are assigned to the nearest RBF centers,
        # and then each center is updated according to the assigned samples.
    ...
    def pseudo_label(self):
        # Pseudo-labels for unlabeled samples are calculated based on the
        # true labels of labeled samples and the output of the network on unlabeled samples.
...
# The code has been slightly modified to remove its reliance on instance objects,
# allowing it to function by simply taking x and y as inputs. The core function is not influenced.
class OSNN:
    def __init__(
            self,
            num_center=10,
